...
const plugins = [];
const links = {
  proxied: "https://claracrazy.github.io/vendetta-mods/",
  code: `https://github.com/claracrazy/vendetta-mods/tree/main/plugins/`,
  external: {
    backend: "https://github.com/claracrazy/",
  },
};
...
<div align="center">
  ${makeHref(
    "https://github.com/claracrazy/vendetta-mods/stargazers",
    `<img alt="GitHub stars" src="https://img.shields.io/github/stars/claracrazy/vendetta-mods?style=for-the-badge&color=${shieldColors.ghstars}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghstars}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/claracrazy/vendetta-mods/issues",
    `<img alt="GitHub issues" src="https://img.shields.io/github/issues/claracrazy/vendetta-mods?style=for-the-badge&color=${shieldColors.ghissues}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghissues}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/claracrazy/vendetta-mods/pulls",
    `<img alt="GitHub pull requests" src="https://img.shields.io/github/issues-pr/claracrazy/vendetta-mods?style=for-the-badge&color=${shieldColors.ghpullreqs}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghpullreqs}">`,
    1,
  )}
  ${makeHref(
...
Out of the plugins I've modified, **${stats.finished}** ${plur(
  ...
  "are finished",
  "is finished",
)}. I'm working on **${stats.unfinished}** plugin${plur(stats.unfinished)}
